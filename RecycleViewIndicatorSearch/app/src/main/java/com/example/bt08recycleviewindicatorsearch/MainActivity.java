package com.example.bt08recycleviewindicatorsearch;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList1.add(new IconModel(R.drawable.icon, "jfdjfdjf dfjh"));
        arrayList1.add(new IconModel(R.drawable.icon, "sddf sdfsd"));
        arrayList1.add(new IconModel(R.drawable.icon, "sddf sdffs"));
        arrayList1.add(new IconModel(R.drawable.icon, "dfgfhv sxdf"));
        arrayList1.add(new IconModel(R.drawable.icon, "sddf sdfsd"));
        arrayList1.add(new IconModel(R.drawable.icon, "sddf sdfsd"));
        arrayList1.add(new IconModel(R.drawable.icon, "jfdjfdjf dfjh"));
        arrayList1.add(new IconModel(R.drawable.icon, "dfgfhv sxdf"));
        arrayList1.add(new IconModel(R.drawable.icon, "sddf sdff"));
        arrayList1.add(new IconModel(R.drawable.icon, "jfdjfdjf dfjh"));
        arrayList1.add(new IconModel(R.drawable.icon, "sddf sdffs"));
        arrayList1.add(new IconModel(R.drawable.icon, "dfgfhv sxdf"));
        arrayList1.add(new IconModel(R.drawable.icon, "sddf sdfsd"));
